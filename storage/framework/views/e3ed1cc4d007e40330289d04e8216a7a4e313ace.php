...
<?php $__env->startSection('title', 'Редактировать профиль'); ?>
            ...
            <div class="card shadow-sm mb-4">
                <div class="card-header bg-white py-3">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="<?php echo e(route('home')); ?>" class="btn btn-secondary-custom btn-custom btn-icon">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            <a href="<?php echo e(route('home')); ?>" class="btn btn-outline-secondary-custom btn-custom btn-icon">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /srv/users/nxxyreps/pyhjavd-m2/resources/views/profile/edit.blade.php ENDPATH**/ ?>