...
<head>
    ...
    <title><?php echo $__env->yieldContent('title'); ?> - GivnGet</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav me-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('items.index')); ?>">Предметы</a>
                    </li>
                    <li class="nav-item">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown">
                                <?php if(Auth::user()->profile_image): ?>
                                    <img src="<?php echo e(Storage::url(Auth::user()->profile_image)); ?>" alt="Profile" class="profile-image">
                                <?php else: ?>
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a class="dropdown-item" href="<?php echo e(route('exchanges.index')); ?>">
    ...
    <footer class="footer mt-5 py-4">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="<?php echo e(route('items.index')); ?>" class="text-decoration-none text-muted">Предметы</a></li>
                        <li><a href="<?php echo e(route('categories.index')); ?>" class="text-decoration-none text-muted">Категории</a></li>
                        <li><a href="<?php echo e(route('exchanges.index')); ?>" class="text-decoration-none text-muted">Мои обмены</a></li>
                    </ul>
                </div>
                <div class="col-md-3">
            ...
            <div class="text-center text-muted">
                <small>&copy; <?php echo e(date('Y')); ?> GivnGet. Все права защищены.</small>
            </div>
        </div>
    </footer>
...
<?php /**PATH /srv/users/nxxyreps/pyhjavd-m2/resources/views/layouts/app.blade.php ENDPATH**/ ?>